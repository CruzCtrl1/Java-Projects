...
// This for loop checks every single letter in the string. Can't stop till all words in the string are checked.
    ...
    {
        int stringLength = input.length();
        int vowels = numberVowels(input);
        int numOfcons = stringLength - vowels;
        // This gets the difference of number of vowels from total number of letters
