...
public class ConvertMeters3{
    ...
    // have been run, the program terminates.
        ...
        int selection = userChoice();
            ...
            switch (selection){
            case 1: 
                System.out.printf("%,.2f meters is %,.2f kilometers.", meters, showKilometers(meters));
                System.out.println(" Goodbye");
                break;
            
            case 2:
                System.out.printf("%,.2f meters is %,.2f inches.", meters, showInches(meters));
                System.out.println(" Goodbye");
                break;
            
            case 3:
                System.out.printf("%,.2f meters is %,.2f feet.", meters, showFeet(meters));
                System.out.println(" Goodbye");
                break;
